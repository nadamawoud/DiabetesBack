...
namespace Diabetes.Repository.Data.Migrations
{
    ...
    [Migration("20250504185938_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Diabetes.Core.Entities.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Diabetes.Core.Entities.ChatbotAnswerDoctor", b =>
                {
                    ...
                    b.ToTable("ChatbotAnswersDoctors");
                });
            ...
            modelBuilder.Entity("Diabetes.Core.Entities.DoctorPatient", b =>
                {
                    b.Property<int>("DoctorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Diabetes.Core.Entities.Admin", b =>
                {
                    b.HasOne("Diabetes.Core.Entities.AppUser", "AppUser")
                        .WithOne("Admin")
                        .HasForeignKey("Diabetes.Core.Entities.Admin", "AppUserId")
            ...
            modelBuilder.Entity("Diabetes.Core.Entities.CasualUser", b =>
                {
                    ...
                    b.HasOne("Diabetes.Core.Entities.AppUser", "AppUser")
                        .WithOne("CasualUser")
                        .HasForeignKey("Diabetes.Core.Entities.CasualUser", "AppUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Diabetes.Core.Entities.Clerk", b =>
                {
                    ...
                    b.HasOne("Diabetes.Core.Entities.AppUser", "AppUser")
                        .WithOne("Clerk")
                        .HasForeignKey("Diabetes.Core.Entities.Clerk", "AppUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Diabetes.Core.Entities.Doctor", b =>
                {
                    ...
                    b.HasOne("Diabetes.Core.Entities.AppUser", "AppUser")
                        .WithOne("Doctor")
                        .HasForeignKey("Diabetes.Core.Entities.Doctor", "AppUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Diabetes.Core.Entities.Manager", b =>
                {
                    ...
                    b.HasOne("Diabetes.Core.Entities.AppUser", "AppUser")
                        .WithOne("Manager")
                        .HasForeignKey("Diabetes.Core.Entities.Manager", "AppUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Diabetes.Core.Entities.Organization", b =>
                {
                    ...
                    b.HasOne("Diabetes.Core.Entities.AppUser", "AppUser")
                        ...
                        .HasForeignKey("Diabetes.Core.Entities.Organization", "AppUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Diabetes.Core.Entities.AppUser", null)
                        .WithMany()
